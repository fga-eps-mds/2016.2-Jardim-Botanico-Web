var southEucalyptusTenPolygon;
function addSouthEucalyptusTenPolygon(){
  var southEucalyptusTenPolygonCoords = [
...
{lat: -15.875400440143663, lng: -47.84272849559784},
  ...
  southEucalyptusTenPolygon = new google.maps.Polygon({
    paths: southEucalyptusTenPolygonCoords,
    strokeColor: '#A1BF77',
    strokeOpacity: 0.1,
    strokeWeight: 3,
    fillColor: '#A1BF77',
  ...
  southEucalyptusTenPolygon.setMap(map);
}
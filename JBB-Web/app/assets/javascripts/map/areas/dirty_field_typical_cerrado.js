var dirtyFieldTypicalCerradoPolygon;
function addDirtyFieldTypicalCerradoPolygon(){
  var dirtyFieldTypicalCerradoPolygonCoords = [
...
{lat: -15.8738782895817, lng: -47.82378673553467},
  ...
  dirtyFieldTypicalCerradoPolygon.setMap(map);
}
var centerBypassAreaRightPolygon;
function addCenterBypassAreaRightPolygon(){
  var centerBypassAreaRightPolygonCoords = [
  ...
  centerBypassAreaRightPolygon = new google.maps.Polygon({
    paths: centerBypassAreaRightPolygonCoords,
    strokeColor: '#A5D772',
    strokeOpacity: 0.1,
    strokeWeight: 3,
    fillColor: '#A5D772',
  ...
  centerBypassAreaRightPolygon.setMap(map);
} 
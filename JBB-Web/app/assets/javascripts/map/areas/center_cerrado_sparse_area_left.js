var centerCerradoSparseAreaLeftPolygon;
function addcenterCerradoSparseAreaLeftPolygon(){
  var centerCerradoSparseAreaLeftPolygonCoords = [
  ...
  centerCerradoSparseAreaLeftPolygon = new google.maps.Polygon({
    paths: centerCerradoSparseAreaLeftPolygonCoords,
    strokeColor: '#399E87',
    strokeOpacity: 0.1,
    strokeWeight: 3,
    fillColor: '#399E87',
  ...
  centerCerradoSparseAreaLeftPolygon.setMap(map);
} 
var centerCerradoSparseAreaRightPolygon;
function addCenterCerradoSparseAreaRightPolygon(){
  var centerCerradoSparseAreaRightPolygonCoords = [
  ...
  centerCerradoSparseAreaRightPolygon = new google.maps.Polygon({
    paths: centerCerradoSparseAreaRightPolygonCoords,
    strokeColor: '#399E87',
    strokeOpacity: 0.1,
    strokeWeight: 3,
    fillColor: '#399E87',
  ...
  centerCerradoSparseAreaRightPolygon.setMap(map);
} 
var eucalyptusTypicalCerradoPolygon;
function addEucalyptusTypicalCerradoPolygon(){
  var eucalyptusTypicalCerradoPolygonCoords = [
  ...
  eucalyptusTypicalCerradoPolygon = new google.maps.Polygon({
    paths: eucalyptusTypicalCerradoPolygonCoords,
    strokeColor: '#A1BF77',
    strokeOpacity: 0.1,
    strokeWeight: 3,
    fillColor: '#A1BF77',

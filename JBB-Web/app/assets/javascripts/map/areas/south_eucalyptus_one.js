var southEucalyptusOnePolygon;
function addSouthEucalyptusOnePolygon(){
  var southEucalyptusOnePolygonCoords = [
...
{lat: -15.865410794719166, lng: -47.840346693992615},
  ...
  southEucalyptusOnePolygon = new google.maps.Polygon({
    paths: southEucalyptusOnePolygonCoords,
    strokeColor: '#A1BF77',
    strokeOpacity: 0.1,
    strokeWeight: 3,
    fillColor: '#A1BF77',
  ...
  southEucalyptusOnePolygon.setMap(map);
}
var centerGroundMurundunsAreaPolygon;
function addCenterGroundMurundunsAreaPolygon(){
  var centerGroundMurundunsAreaPolygonCoords = [
  ...
  centerGroundMurundunsAreaPolygon = new google.maps.Polygon({
    paths: centerGroundMurundunsAreaPolygonCoords,
    strokeColor: '#42CCD0',
    strokeOpacity: 0.1,
    strokeWeight: 3,
    fillColor: '#42CCD0',
  ...
  centerGroundMurundunsAreaPolygon.setMap(map);
} 
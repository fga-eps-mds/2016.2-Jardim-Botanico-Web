var southPathPolygon;
function addSouthPathPolygon(){
  var southPathPolygonCoords = [
...
{lat: -15.868161092569927, lng: -47.848849296569824},
  ...
  southPathPolygon = new google.maps.Polygon({
    paths: southPathPolygonCoords,
    strokeColor: '#C3DD9E',
    strokeOpacity: 0.1,
    strokeWeight: 3,
    fillColor: '#C3DD9E',

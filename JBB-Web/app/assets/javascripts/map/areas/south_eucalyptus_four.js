var southEucalyptusFourPolygon;
function addSouthEucalyptusFourPolygon(){
  var southEucalyptusFourPolygonCoords = [
...
{lat: -15.868739011549847, lng: -47.84141421318054},
  ...
  southEucalyptusFourPolygon = new google.maps.Polygon({
    paths: southEucalyptusFourPolygonCoords,
    strokeColor: '#A1BF77',
    strokeOpacity: 0.1,
    strokeWeight: 3,
    fillColor: '#A1BF77',
  ...
  southEucalyptusFourPolygon.setMap(map);
}
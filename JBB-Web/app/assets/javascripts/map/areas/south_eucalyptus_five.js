var southEucalyptusFivePolygon;
function addSouthEucalyptusFivePolygon(){
  var southEucalyptusFivePolygonCoords = [
...
{lat: -15.870297320541042, lng: -47.84151077270508},
  ...
  southEucalyptusFivePolygon = new google.maps.Polygon({
    paths: southEucalyptusFivePolygonCoords,
    strokeColor: '#A1BF77',
    strokeOpacity: 0.1,
    strokeWeight: 3,
    fillColor: '#A1BF77',
  ...
  southEucalyptusFivePolygon.setMap(map);
}
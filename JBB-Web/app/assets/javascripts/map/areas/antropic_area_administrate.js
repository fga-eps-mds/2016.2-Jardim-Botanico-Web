var anthropicAreaAdministratePolygon;
function addAnthropicAreaAdministratePolygon(){
  var anthropicAreaAdministratePolygonCoords = [
  ...
  anthropicAreaAdministratePolygon = new google.maps.Polygon({
    paths: anthropicAreaAdministratePolygonCoords,
    strokeColor: '#589C5F',
    strokeOpacity: 0.1,
    strokeWeight: 3,
    fillColor: '#589C5F',

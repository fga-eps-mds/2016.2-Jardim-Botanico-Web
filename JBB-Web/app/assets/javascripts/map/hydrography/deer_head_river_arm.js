...
function addDeerHeadRiverArm(){
    ...
    deerHeadRiverArm = new google.maps.Polyline({
        path: deerHeadRiverArmCoordinates,
        map: map,
        strokeColor: '#366ED4',
        strokeWidth: 0.3,
    });
    ...
    google.maps.event.addListener(deerHeadRiverArm, 'click', addDeerHeadRiverArmInfowindow);
}

function addDeerHeadRiverArmInfowindow(event){
    ...
    infoWindow.close();
    infoWindow.setContent(deerHeadRiverArmContentString);

...
function addCaesb4River(){
    ...
    caesb4River = new google.maps.Polyline({
        path: caesb4RiverCoordinates,
        map: map,
        strokeColor: '#366ED4',
        strokeWidth: 0.3
    });
    ...
    google.maps.event.addListener(caesb4River, 'click', addCaesb4RiverInfowindow);
  }

  function addCaesb4RiverInfowindow(event){
